...
/* harmony import */ var _ws_widget_collection__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @ws-widget/collection */ "./library/ws-widget/collection/src/public-api.ts");
/* harmony import */ var _ws_author_src_lib_services_notification_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ws/author/src/lib/services/notification.service */ "./project/ws/author/src/lib/services/notification.service.ts");
...
let UploadComponent = class UploadComponent {
    constructor(authInitService, contentService, snackBar, editorService, dialog, router, loaderService, accessService, notificationSvc) {
        ...
        this.fullScreenToggle = () => {
            const doc = document;
            const elm = doc.getElementById('upload-container');
    ...
    createInAnotherLanguage(language) {
        ...
        this.contentService.createInAnotherLanguage(language, meta).subscribe(data => {
            this.loaderService.changeLoad.next(false);
            if (data !== true) {
    ...
    finalCall(commentsForm) {
        if (commentsForm) {
            ...
            const saveCall = (needSave
                ...
                : Object(rxjs__WEBPACK_IMPORTED_MODULE_16__["of"])({})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["mergeMap"])(() => this.editorService
    ...
    preview() {
        ...
        this.loaderService.changeLoad.next(true);
        saveCall.subscribe(() => {
            this.mimeTypeRoute = Object(_ws_widget_collection__WEBPACK_IMPORTED_MODULE_18__["VIEWER_ROUTE_FROM_MIME"])(this.contentService.getUpdatedMeta(this.currentContent).mimeType);
            this.loaderService.changeLoad.next(false);
    ...
    triggerSave(meta, id) {
        ...
        return this.editorService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["tap"])(() => this.contentService.resetOriginalMeta(meta, id)));
    }
    getMessage(type) {
        if (type === 'success') {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _components_upload_upload_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/upload/upload.component */ "./project/ws/author/src/lib/routing/modules/editor/routing/modules/upload/components/upload/upload.component.ts");
...
/* harmony import */ var _components_upload_upload_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/upload/upload.component */ "./project/ws/author/src/lib/routing/modules/editor/routing/modules/upload/components/upload/upload.component.ts");
/* harmony import */ var _upload_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./upload-routing.module */ "./project/ws/author/src/lib/routing/modules/editor/routing/modules/upload/upload-routing.module.ts");
...
UploadModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            _components_upload_upload_component__WEBPACK_IMPORTED_MODULE_6__["UploadComponent"],
        ],
        exports: [
        // FileUploadComponent
        ],
...
//# sourceMappingURL=default~routing-modules-collection-collection-module~routing-modules-upload-upload-module-es2015.js.map