...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["routing-modules-my-content-my-content-module"], {
  ...
  /*! exports provided: default */
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentComponentsContentCardV2ContentCardV2ComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentComponentsContentCardV2ContentCardV2ComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */
    __webpack_require__.d(__webpack_exports__, "ContentCardV2Component", function () {
      return ContentCardV2Component;
    });
    /* harmony import */
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! tslib */"./node_modules/tslib/tslib.es6.js");
    /* harmony import */
    var _modules_shared_components_status_track_status_track_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! ./../../../../../modules/shared/components/status-track/status-track.component */"./project/ws/author/src/lib/modules/shared/components/status-track/status-track.component.ts");
    /* harmony import */
    var _ws_author_src_lib_modules_shared_components_auth_expiry_date_confirm_auth_expiry_date_confirm_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/components/auth-expiry-date-confirm/auth-expiry-date-confirm.component */"./project/ws/author/src/lib/modules/shared/components/auth-expiry-date-confirm/auth-expiry-date-confirm.component.ts");
    /* harmony import */
    var _ws_author_src_lib_modules_shared_components_draft_dialog_draft_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/components/draft-dialog/draft-dialog.component */"./project/ws/author/src/lib/modules/shared/components/draft-dialog/draft-dialog.component.ts");
    /* harmony import */
    var _ws_author_src_lib_modules_shared_components_unpublish_dialog_unpublish_dialog_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/components/unpublish-dialog/unpublish-dialog.component */"./project/ws/author/src/lib/modules/shared/components/unpublish-dialog/unpublish-dialog.component.ts");
    /* harmony import */
    var _ws_author_src_lib_modules_shared_components_restore_dialog_restore_dialog_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/components/restore-dialog/restore-dialog.component */"./project/ws/author/src/lib/modules/shared/components/restore-dialog/restore-dialog.component.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _ws_author_src_lib_services_init_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! @ws/author/src/lib/services/init.service */"./project/ws/author/src/lib/services/init.service.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _ws_author_src_lib_modules_shared_components_delete_dialog_delete_dialog_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/components/delete-dialog/delete-dialog.component */"./project/ws/author/src/lib/modules/shared/components/delete-dialog/delete-dialog.component.ts");
    var ContentCardV2Component = /*#__PURE__*/function () {
      function ContentCardV2Component(accessService, dialog, initService, valueSvc) {
        _classCallCheck(this, ContentCardV2Component);
      ...
      _createClass(ContentCardV2Component, [{
        key: "getLocale",
        value: function getLocale(locale) {
          var language = this.initService.ordinals.subTitles.find(function (v) {
            return v.srclang === locale;
          });
        ...
        value: function ngOnInit() {
          ...
          this.valueSvc.isXSmall$.subscribe(function (isMobile) {
            return _this.isMobile = isMobile;
          });
          ...
          this.languages = this.initService.ordinals.subTitles.filter(function (elem) {
            return !_this.translationArray.find(function (item) {
              return elem.srclang === item.locale;
            });
          });
          this.translationArray = this.translationArray.map(function (v) {
            return {
              locale: _this.getLocale(v.locale),
          ...
          if (this.perspective === 'author' || this.perspective === 'reviewer') {
            if (this.content.status === 'Draft') {
              ...
              } else if (this.content.publisherDetails.find(function (v) {
                return v.id === _this.accessService.userId;
              }) || this.content.trackContacts.find(function (v) {
                return v.id === _this.accessService.userId;
              })) {
                this.mainAction = 'takeAction';
              } else if (this.content.creatorContacts.find(function (v) {
                return v.id === _this.accessService.userId;
              })) {
          ...
          if (!this.initService.authAdditionalConfig.allowActionHistory) {
            var index = this.allowedActions.indexOf('history');
        ...
        value: function _delete() {
          var _this2 = this;
          var dialog = this.dialog.open(_ws_author_src_lib_modules_shared_components_delete_dialog_delete_dialog_component__WEBPACK_IMPORTED_MODULE_11__["DeleteDialogComponent"], {
          ...
          dialog.afterClosed().subscribe(function (v) {
            if (v) {
              _this2.onClick('remove');
            }
          });
        }
      }, {
        key: "actionHistory",
        value: function actionHistory() {
        ...
        value: function restore() {
          var _this3 = this;
          var dialog = this.dialog.open(_ws_author_src_lib_modules_shared_components_restore_dialog_restore_dialog_component__WEBPACK_IMPORTED_MODULE_5__["RestoreDialogComponent"], {
            width: this.isMobile ? '90vw' : '600px',
            height: 'auto',
            data: this.content
          });
        ...
        value: function unpublish() {
          var _this4 = this;
          var dialog = this.dialog.open(_ws_author_src_lib_modules_shared_components_unpublish_dialog_unpublish_dialog_component__WEBPACK_IMPORTED_MODULE_4__["UnpublishDialogComponent"], {
            width: this.isMobile ? '90vw' : '600px',
            height: 'auto',
            data: this.content
          });
        ...
        key: "moveToDraft",
        value: function moveToDraft() {
          var _this5 = this;
          var dialog = this.dialog.open(_ws_author_src_lib_modules_shared_components_draft_dialog_draft_dialog_component__WEBPACK_IMPORTED_MODULE_3__["DraftDialogComponent"], {
            width: this.isMobile ? '90vw' : '600px',
            height: 'auto',
            data: this.content
          });
        ...
        key: "extendOrExpiry",
        value: function extendOrExpiry() {
          var _this6 = this;
          var dialog = this.dialog.open(_ws_author_src_lib_modules_shared_components_auth_expiry_date_confirm_auth_expiry_date_confirm_component__WEBPACK_IMPORTED_MODULE_2__["AuthExpiryDateConfirmComponent"], {
            width: this.isMobile ? '90vw' : '600px',
            height: 'auto',
            data: this.content
          });
          dialog.afterClosed().subscribe(function (v) {
            if (v) {
              _this6.onClick('remove');
            }
          });
        }
      }, {
        key: "changeToGlobalSymbol",
        value: function changeToGlobalSymbol($event) {
          $event.target.src = '/assets/common/flags/pref.png';
        }
      }]);
      return ContentCardV2Component;
    }();
    ContentCardV2Component.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_9__["Input"])()], ContentCardV2Component.prototype, "perspective", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_9__["Input"])()], ContentCardV2Component.prototype, "content", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_9__["Output"])()], ContentCardV2Component.prototype, "action", void 0);
    ContentCardV2Component = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_9__["Component"])({
  ...
  /*! exports provided: default */
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentComponentsContentCardContentCardComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentComponentsContentCardContentCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ContentCardComponent = /*#__PURE__*/function () {
      function ContentCardComponent(accessService) {
      ...
      _createClass(ContentCardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.filteredSubTitles = this.translationArray.length ? this.ordinals.subTitles.filter(function (elem) {
            return !_this7.translationArray.find(function (item) {
              return elem.srclang === item.locale;
            });
        ...
        key: "getName",
        value: function getName(lang) {
          var language = this.ordinals.subTitles.find(function (v) {
            return v.srclang === lang;
          });
          return language ? language.label : lang;
        }
      }, {
        key: "showMenuItem",
        value: function showMenuItem(menuType) {
          ...
          switch (menuType) {
            ...
            case 'delete':
              ...
              break;
            case 'moveToDraft':
              if (this.data.status === 'InReview' || this.data.status === 'Unpublished' || this.data.status === 'Reviewed' || this.data.status === 'QualityReview') {
                returnValue = this.accessService.hasAccess(Object.assign({}, this.data, {
                  status: 'Draft'
                }));
              }
              break;
        ...
        key: "takeAction",
        value: function takeAction(actionType) {
          this.action.emit({
            type: actionType,
            data: this.data
          });
    ...
    ContentCardComponent.ctorParameters = function () {
      return [{
        type: _ws_author_src_lib_modules_shared_services_access_control_service__WEBPACK_IMPORTED_MODULE_2__["AccessControlService"]
      }];
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ContentCardComponent.prototype, "data", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ContentCardComponent.prototype, "ordinals", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ContentCardComponent.prototype, "forExpiry", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ContentCardComponent.prototype, "forDelete", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ContentCardComponent.prototype, "changeView", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], ContentCardComponent.prototype, "action", void 0);
  ...
  /*! exports provided: default */
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentComponentsMyContentMyContentComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentComponentsMyContentMyContentComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! tslib */"./node_modules/tslib/tslib.es6.js");
    /* harmony import */
    var _ws_author_src_lib_modules_shared_components_auth_expiry_date_confirm_auth_expiry_date_confirm_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/components/auth-expiry-date-confirm/auth-expiry-date-confirm.component */"./project/ws/author/src/lib/modules/shared/components/auth-expiry-date-confirm/auth-expiry-date-confirm.component.ts");
    /* harmony import */
    var _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! @angular/cdk/tree */"./node_modules/@angular/cdk/esm2015/tree.js");
    /* harmony import */
    ...
    /* harmony import */
    var _ws_author_src_lib_modules_shared_services_access_control_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__( /*! @ws/author/src/lib/modules/shared/services/access-control.service */"./project/ws/author/src/lib/modules/shared/services/access-control.service.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _services_my_content_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__( /*! ../../services/my-content.service */"./project/ws/author/src/lib/routing/modules/my-content/services/my-content.service.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _ws_author_src_lib_constants_content_role__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__( /*! @ws/author/src/lib/constants/content-role */"./project/ws/author/src/lib/constants/content-role.ts");
    var MyContentComponent = /*#__PURE__*/function () {
      function MyContentComponent(myContSvc, activatedRoute, router, loadService, accessService, snackBar, dialog, authInitService) {
        ...
        this.filterMenuTreeControl = new _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_2__["FlatTreeControl"](function (node) {
          return node.levels;
        }, function (node) {
          return node.expandable;
        });
        this.filterMenuTreeFlattener = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTreeFlattener"](this._transformer, function (node) {
          return node.levels;
        }, function (node) {
          return node.expandable;
        }, function (node) {
      ...
      _createClass(MyContentComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            _this8.status = params.status;
            _this8.setAction();
            _this8.fetchContent(false);
          });
        ...
        key: "fetchContent",
        value: function fetchContent(loadMoreFlag) {
          var _this9 = this;
          var changeFilter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
          var searchV6Data = this.myContSvc.getSearchBody(this.status, this.searchLanguage ? [this.searchLanguage] : [], loadMoreFlag ? this.pagination.offset : 0, this.queryFilter, this.isAdmin);
          var requestData = {
            request: {
          ...
          if (this.finalFilters.length) {
            this.finalFilters.forEach(function (v) {
              searchV6Data.filters.forEach(function (filter) {
                filter.andFilters[0] = Object.assign({}, filter.andFilters[0], _defineProperty({}, v.key, v.value));
              });
              requestData.request.filters = Object.assign({}, requestData.request.filters, _defineProperty({}, v.key, v.value));
            });
          }
          if (this.queryFilter) {
            delete requestData.request.sort;
          }
          if (['draft', 'rejected', 'inreview', 'published', 'unpublished', 'processing', 'deleted'].indexOf(this.status) > -1 && !this.isAdmin) {
          ...
          var observable = this.status === 'expiry' || this.newDesign ? this.myContSvc.fetchFromSearchV6(searchV6Data, this.isAdmin).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_16__["map"])(function (v) {
            return {
              result: {
                response: v
              }
          ...
          observable.subscribe(function (data) {
            _this9.loadService.changeLoad.next(false);
            if (changeFilter) {
              _this9.filterMenuItems = data && data.result && data.result.response && data.result.response.filters ? data.result.response.filters : _this9.filterMenuItems;
              _this9.dataSource.data = _this9.filterMenuItems;
            }
            _this9.cardContent = loadMoreFlag && !_this9.queryFilter ? (_this9.cardContent || []).concat(data && data.result && data.result.response ? data.result.response.result : []) : data && data.result.response ? data.result.response.result : [];
            _this9.totalContent = data && data.result.response ? data.result.response.totalHits : 0;
            _this9.showLoadMore = _this9.pagination.offset * _this9.pagination.limit + _this9.pagination.limit < _this9.totalContent ? true : false;
            _this9.fetchError = false;
          }, function () {
            _this9.fetchError = true;
            _this9.cardContent = [];
            _this9.showLoadMore = false;
            _this9.loadService.changeLoad.next(false);
          });
        }
      }, {
        ...
        key: "filterApplyEvent",
        value: function filterApplyEvent(node) {
          this.pagination.offset = 0;
          this.sideNavBarOpened = false;
          var filterIndex = this.filters.findIndex(function (v) {
            return v.displayName === node.displayName;
          });
          var filterMenuItemsIndex = this.filterMenuItems.findIndex(function (obj) {
            return obj.content.some(function (val) {
              return val.type === node.type;
            });
          });
          var ind = this.finalFilters.indexOf(this.filterMenuItems[filterMenuItemsIndex].type);
          if (filterIndex === -1 && node.checked) {
            this.filters.push(node);
            this.filterMenuItems[filterMenuItemsIndex].content.find(function (v) {
              return v.displayName === node.displayName;
            }).checked = true;
            if (ind === -1) {
        ...
        key: "deleteContent",
        value: function deleteContent(request) {
          var _this10 = this;
          this.loadService.changeLoad.next(true);
          this.myContSvc.deleteContent(request.identifier, request.contentType === 'Knowledge Board').subscribe(function () {
            _this10.loadService.changeLoad.next(false);
            _this10.snackBar.openFromComponent(_ws_author_src_lib_modules_shared_components_notification_notification_component__WEBPACK_IMPORTED_MODULE_11__["NotificationComponent"], {
              data: {
            ...
            _this10.cardContent = (_this10.cardContent || []).filter(function (v) {
              return v.identifier !== request.identifier;
            });
          }, function (error) {
            if (error.status === 409) {
              _this10.dialog.open(_ws_author_src_lib_modules_shared_components_error_parser_error_parser_component__WEBPACK_IMPORTED_MODULE_10__["ErrorParserComponent"], {
                width: '80vw',
                height: '90vh',
                data: {
        ...
        key: "restoreContent",
        value: function restoreContent(request) {
          var _this11 = this;
          this.loadService.changeLoad.next(true);
          this.myContSvc.restoreContent(request.identifier).subscribe(function () {
            _this11.loadService.changeLoad.next(false);
            ...
            _this11.cardContent = (_this11.cardContent || []).filter(function (v) {
              return v.identifier !== request.identifier;
            });
          }, function (error) {
            if (error.status === 409) {
              _this11.dialog.open(_ws_author_src_lib_modules_shared_components_error_parser_error_parser_component__WEBPACK_IMPORTED_MODULE_10__["ErrorParserComponent"], {
                width: '80vw',
                height: '90vh',
                data: {
                  errorFromBackendData: error.error
        ...
        key: "createContent",
        value: function createContent(request) {
          var _this12 = this;
          this.loadService.changeLoad.next(true);
          this.myContSvc.createInAnotherLanguage(request.identifier, request.locale).subscribe(function (id) {
            _this12.loadService.changeLoad.next(false);
            _this12.snackBar.openFromComponent(_ws_author_src_lib_modules_shared_components_notification_notification_component__WEBPACK_IMPORTED_MODULE_11__["NotificationComponent"], {
              data: {
                type: _ws_author_src_lib_constants_notificationMessage__WEBPACK_IMPORTED_MODULE_7__["Notify"].CONTENT_CREATE_SUCCESS
              },
              duration: _ws_author_src_lib_constants_constant__WEBPACK_IMPORTED_MODULE_6__["NOTIFICATION_TIME"] * 1000
            });
            _this12.router.navigateByUrl("/author/editor/".concat(id));
          }, function (error) {
            if (error.status === 409) {
              _this12.dialog.open(_ws_author_src_lib_modules_shared_components_error_parser_error_parser_component__WEBPACK_IMPORTED_MODULE_10__["ErrorParserComponent"], {
                width: '750px',
                height: '450px',
                data: {
                  errorFromBackendData: error.error
        ...
        value: function clearAllFilters() {
          ...
          this.queryFilter = '';
          this.filterMenuItems.map(function (val) {
        ...
        key: "confirmAction",
        value: function confirmAction(content) {
          var _this13 = this;
          var message = '';
          ...
          var dialogRef = this.dialog.open(_ws_author_src_lib_modules_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmDialogComponent"], {
            width: '600px',
            height: '200px',
            data: message
          });
          dialogRef.afterClosed().subscribe(function (confirm) {
            if (confirm) {
              if (content.type === 'delete') {
                _this13.deleteContent(content.data);
              } else if (content.type === 'restoreDeleted') {
                _this13.restoreContent(content.data);
              } else if (content.type === 'unpublish' || content.type === 'moveToDraft' && content.data.status === 'Unpublished') {
                _this13.unPublishOrDraft(content.data);
              } else {
                _this13.forwardBackward(content);
              }
            }
          });
        }
      }, {
        key: "unPublishOrDraft",
        value: function unPublishOrDraft(request) {
          var _this14 = this;
          this.loadService.changeLoad.next(true);
          this.myContSvc.upPublishOrDraft(request.identifier, request.status !== 'Unpublished').subscribe(function () {
            _this14.loadService.changeLoad.next(false);
            ...
            _this14.cardContent = (_this14.cardContent || []).filter(function (v) {
              return v.identifier !== request.identifier;
            });
          }, function (error) {
            if (error.status === 409) {
              _this14.dialog.open(_ws_author_src_lib_modules_shared_components_error_parser_error_parser_component__WEBPACK_IMPORTED_MODULE_10__["ErrorParserComponent"], {
                width: '750px',
                height: '450px',
                data: {
                  errorFromBackendData: error.error
        ...
        key: "forwardBackward",
        value: function forwardBackward(content) {
          var _this15 = this;
          ...
          dialogRef.afterClosed().subscribe(function (commentsForm) {
            if (commentsForm) {
              _this15.finalCall(commentsForm, content);
            }
          });
        }
      }, {
        key: "finalCall",
        value: function finalCall(commentsForm, content) {
          var _this16 = this;
          if (commentsForm) {
            var operationValue;
            switch (content.type) {
            ...
            this.loadService.changeLoad.next(true);
            this.myContSvc.forwardBackward(body, content.data.identifier, content.data.status).subscribe(function () {
              _this16.loadService.changeLoad.next(false);
              _this16.snackBar.openFromComponent(_ws_author_src_lib_modules_shared_components_notification_notification_component__WEBPACK_IMPORTED_MODULE_11__["NotificationComponent"], {
                data: {
                  type: _ws_author_src_lib_constants_notificationMessage__WEBPACK_IMPORTED_MODULE_7__["Notify"].SUCCESS
                },
                duration: _ws_author_src_lib_constants_constant__WEBPACK_IMPORTED_MODULE_6__["NOTIFICATION_TIME"] * 1000
              });
              _this16.cardContent = (_this16.cardContent || []).filter(function (v) {
                return v.identifier !== content.data.identifier;
              });
            }, function (error) {
              if (error.status === 409) {
                _this16.dialog.open(_ws_author_src_lib_modules_shared_components_error_parser_error_parser_component__WEBPACK_IMPORTED_MODULE_10__["ErrorParserComponent"], {
                  width: '80vw',
                  height: '90vh',
                  data: {
                    errorFromBackendData: error.error
        ...
        value: function action(event) {
          switch (event.type) {
            ...
            case 'publish':
            case 'edit':
              this.router.navigateByUrl("/author/editor/".concat(event.data.identifier));
              break;
            case 'remove':
              this.cardContent = (this.cardContent || []).filter(function (v) {
                return v.identifier !== event.data.identifier;
              });
              break;
            case 'moveToInReview':
            case 'moveToDraft':
        ...
        key: "actionOnExpiry",
        value: function actionOnExpiry(content) {
          var _this17 = this;
          var dialogRef = this.dialog.open(_ws_author_src_lib_modules_shared_components_auth_expiry_date_confirm_auth_expiry_date_confirm_component__WEBPACK_IMPORTED_MODULE_1__["AuthExpiryDateConfirmComponent"], {
            width: '750px',
            height: '300px',
            data: content
          });
          dialogRef.afterClosed().subscribe(function (userAction) {
            if (userAction) {
              _this17.cardContent = (_this17.cardContent || []).filter(function (v) {
    ...
    MyContentComponent.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])('searchInput', {
      "static": false
    })], MyContentComponent.prototype, "searchInputElem", void 0);
    MyContentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
  ...
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentMyContentRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */
    __webpack_require__.d(__webpack_exports__, "MyContentRoutingModule", function () {
      return MyContentRoutingModule;
    });
    /* harmony import */
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! tslib */"./node_modules/tslib/tslib.es6.js");
    /* harmony import */
    ...
    /* harmony import */
    var _components_my_content_my_content_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__( /*! ./components/my-content/my-content.component */"./project/ws/author/src/lib/routing/modules/my-content/components/my-content/my-content.component.ts");
    var routes = [{
      path: '',
      component: _components_my_content_my_content_component__WEBPACK_IMPORTED_MODULE_3__["MyContentComponent"]
    }];
    var MyContentRoutingModule = /*#__PURE__*/_createClass(function MyContentRoutingModule() {
      _classCallCheck(this, MyContentRoutingModule);
    });
    MyContentRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentMyContentModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */
    __webpack_require__.d(__webpack_exports__, "MyContentModule", function () {
      return MyContentModule;
    });
    /* harmony import */
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! tslib */"./node_modules/tslib/tslib.es6.js");
    /* harmony import */
    ...
    /* harmony import */
    var _components_content_card_content_card_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! ./components/content-card/content-card.component */"./project/ws/author/src/lib/routing/modules/my-content/components/content-card/content-card.component.ts");
    /* harmony import */
    var _components_my_content_my_content_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! ./components/my-content/my-content.component */"./project/ws/author/src/lib/routing/modules/my-content/components/my-content/my-content.component.ts");
    /* harmony import */
    var _my_content_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! ./my-content-routing.module */"./project/ws/author/src/lib/routing/modules/my-content/my-content-routing.module.ts");
    /* harmony import */
    var _services_my_content_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__( /*! ./services/my-content.service */"./project/ws/author/src/lib/routing/modules/my-content/services/my-content.service.ts");
    /* harmony import */
    var _components_content_card_v2_content_card_v2_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__( /*! ./components/content-card-v2/content-card-v2.component */"./project/ws/author/src/lib/routing/modules/my-content/components/content-card-v2/content-card-v2.component.ts");
    /* harmony import */
    var _ws_widget_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__( /*! @ws-widget/utils */"./library/ws-widget/utils/src/public-api.ts");
    var MyContentModule = /*#__PURE__*/_createClass(function MyContentModule() {
      _classCallCheck(this, MyContentModule);
    });
    MyContentModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
  ...
  /***/
  function projectWsAuthorSrcLibRoutingModulesMyContentServicesMyContentServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__);
    /* harmony export (binding) */
    __webpack_require__.d(__webpack_exports__, "MyContentService", function () {
    ...
    /* harmony import */
    var _services_init_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__( /*! ./../../../../services/init.service */"./project/ws/author/src/lib/services/init.service.ts");
    var MyContentService = /*#__PURE__*/function () {
      function MyContentService(authInitService, apiService, accessService, configSvc) {
        _classCallCheck(this, MyContentService);
        this.authInitService = authInitService;
        this.apiService = apiService;
        this.accessService = accessService;
        this.configSvc = configSvc;
      }
      _createClass(MyContentService, [{
        key: "fetchContent",
        value: function fetchContent(searchData) {
          return this.apiService.post(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["SEARCH"], searchData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (data) {
            return data;
          }));
        }
      }, {
        ...
        value: function deleteContent(id) {
          var isKnowledgeBoard = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
          return isKnowledgeBoard ? this.apiService["delete"]("".concat(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["CONTENT_DELETE"], "/").concat(id, "/kb").concat(this.accessService.orgRootOrgAsQuery)) : this.apiService.post("".concat(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["CONTENT_DELETE"]).concat(this.accessService.orgRootOrgAsQuery), {
            identifier: id,
        ...
        key: "restoreContent",
        value: function restoreContent(id) {
          return this.apiService.post("".concat(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["CONTENT_RESTORE"]).concat(this.accessService.orgRootOrgAsQuery), {
            identifier: id,
            author: this.accessService.userId,
            isAdmin: this.accessService.hasRole(['editor', 'admin'])
          });
        ...
        key: "fetchFromSearchV6",
        value: function fetchFromSearchV6(searchData) {
          var forAdmin = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        ...
        key: "readContent",
        value: function readContent(id) {
          return this.apiService.get("".concat(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["CONTENT_READ"]).concat(id).concat(this.accessService.orgRootOrgAsQuery));
        }
      }, {
        key: "createInAnotherLanguage",
        value: function createInAnotherLanguage(id, lang) {
          var _this18 = this;
          return this.readContent(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["mergeMap"])(function (content) {
            var requestObj = {};
            Object.keys(_this18.authInitService.authConfig).map(function (v) {
              return requestObj[v] = content[v] ? content[v] : JSON.parse(JSON.stringify(_this18.authInitService.authConfig[v].defaultValue[content.contentType
            ...
            return _this18.create(requestObj);
          }));
        }
      }, {
        key: "create",
        value: function create(meta) {
          ...
          if (this.accessService.rootOrg === 'client2') {
            if (meta.contentType === 'Knowledge Artifact') {
              try {
                var userPath = "client2/Australia/dealer_code-".concat(this.configSvc.unMappedUser.json_unmapped_fields.dealer_group_code);
          ...
          return this.apiService.post( // tslint:disable-next-line:max-line-length
          "".concat(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["CONTENT_CREATE"]).concat(this.accessService.orgRootOrgAsQuery), requestBody).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (data) {
            return data.identifier;
          }));
        }
      }, {
        key: "forwardBackward",
        value: function forwardBackward(meta, id, status) {
        ...
        key: "actionOnExpiry",
        value: function actionOnExpiry(meta, id) {
          var requestBody = Object.assign({}, meta, {
            identifier: id,
            org: this.accessService.org,
            rootOrg: this.accessService.rootOrg || ''
          });
        ...
        key: "upPublishOrDraft",
        value: function upPublishOrDraft(id) {
          var unpublish = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
          var requestBody = {
            unpublish: unpublish,
            identifier: id
          };
          return this.apiService.post("".concat(_ws_author_src_lib_constants_apiEndpoints__WEBPACK_IMPORTED_MODULE_4__["UNPUBLISH"]).concat(this.accessService.orgRootOrgAsQuery), requestBody, true, {
        ...
        key: "getSearchBody",
        value: function getSearchBody(mode) {
          ...
          var forAdmin = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
          var pageSize = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 24;
          var searchV6Body = {
            locale: locale,
            pageSize: pageSize,
            pageNo: pageNo,
            ...
            if (!forAdmin) {
              searchV6Body.filters[0] = {
                andFilters: [{
                  ...
                  status: ['Draft', 'InReview', 'Reviewed', 'Processing', 'Live', 'Deleted', 'Unpublished', 'QualityReview', 'Expired', 'MarkedForDeletion']
                }]
              };
              searchV6Body.filters[1] = {
                andFilters: [{
                  trackContacts: [this.accessService.userId],
                  status: ['InReview']
                }]
              };
              searchV6Body.filters[2] = {
                andFilters: [{
                  publisherDetails: [this.accessService.userId],
                  status: ['Reviewed']
                }]
              };
            } else {
              searchV6Body.filters[0].andFilters[0].status = ['Draft', 'InReview', 'Reviewed', 'Processing', 'Live', 'Deleted', 'Unpublished', 'QualityReview', 'Expired', 'MarkedForDeletion'];
            }
          } else if (mode === 'expiry') {
    ...
    MyContentService.ctorParameters = function () {
      return [{
    ...
    MyContentService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])()], MyContentService);

    /***/
  }
}]);
//# sourceMappingURL=routing-modules-my-content-my-content-module-es5.js.map