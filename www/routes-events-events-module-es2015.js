...
/* harmony import */ var _live_events_live_events_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./live-events/live-events.component */ "./project/ws/app/src/lib/routes/infy/routes/events/live-events/live-events.component.ts");
...
/* harmony import */ var _events_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./events-routing.module */ "./project/ws/app/src/lib/routes/infy/routes/events/events-routing.module.ts");
/* harmony import */ var _live_events_live_events_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./live-events/live-events.component */ "./project/ws/app/src/lib/routes/infy/routes/events/live-events/live-events.component.ts");
...
/* harmony import */ var _ws_widget_resolver__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ws-widget/resolver */ "./library/ws-widget/resolver/src/public-api.ts");
/* harmony import */ var _ws_widget_collection__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ws-widget/collection */ "./library/ws-widget/collection/src/public-api.ts");
...
EventsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _ws_widget_resolver__WEBPACK_IMPORTED_MODULE_11__["WidgetResolverModule"],
            _ws_widget_collection__WEBPACK_IMPORTED_MODULE_12__["BtnPageBackModule"],
        ],
    })
], EventsModule);
...
/* harmony import */ var _src_app_services_mobile_apps_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../../../../../src/app/services/mobile-apps.service */ "./src/app/services/mobile-apps.service.ts");
/* harmony import */ var _services_events_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/events.service */ "./project/ws/app/src/lib/routes/infy/routes/events/services/events.service.ts");
...
let LiveEventsComponent = class LiveEventsComponent {
    constructor(activatedRoute, sanitizer, mobileAppsSvc, 
    ...
    ngOnInit() {
        this.eventsSvc.fetchLiveEvents().subscribe((response) => {
        ...
        this.activatedRoute.queryParamMap.subscribe(qparamsMap => {
            ...
            if (this.liveUrl) {
                ...
                this.notifierSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["interval"])(30000).subscribe(() => {
                    // this.notifier('RUNNING')
                });
...
LiveEventsComponent.ctorParameters = () => [
...
LiveEventsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let EventsService = class EventsService {
    ...
    fetchLiveEvents() {
        return this.http.get(`${API_END_POINTS.LIVE_EVENTS}`);
    }
};
...
//# sourceMappingURL=routes-events-events-module-es2015.js.map